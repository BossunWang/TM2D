...
from motion_loaders.txm_transformer_model_dataset import TXMTransformerGeneratedDataset
...
def get_motion_loader(opt_path, batch_size, ground_truth_dataset, mm_num_samples, mm_num_repeats, device):
    ...
    if opt.dataset_name == 't2m' or opt.dataset_name == 'kit' or opt.dataset_name == 'aistppml3d':
    ...
    elif 'ATM' in opt.name:
        dataset = TXMTransformerGeneratedDataset(opt, ground_truth_dataset, w_vectorizer, mm_num_samples, mm_num_repeats)
