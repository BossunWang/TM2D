...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--log_every', type=int, default=300, help='Frequency of printing training progress')
        ...
        # addition param for VAE
        self.parser.add_argument('--lambda_kl', type=float, default=0.005, help='lambda for KL loss')
        self.parser.add_argument('--lambda_zd', type=float, default=0., help='lambda for KL loss')
        self.parser.add_argument('--lambda_zm', type=float, default=0., help='lambda for KL loss')  # atm v2
        self.parser.add_argument('--lambda_zv', type=float, default=0., help='lambda for KL loss')  # atm v2
        # self.parser.add_argument('--lambda_x2x', type=float, default=0, help='lambda for KL loss')  # atm v1
        self.parser.add_argument('--lambda_zt', type=float, default=0., help='lambda for KL loss')  # atm v3


        self.parser.add_argument('--lambda_a2a', type=float, default=0, help='lambda for KL loss')
        self.parser.add_argument('--lambda_a2d', type=float, default=1, help='lambda for KL loss')
        self.parser.add_argument('--lambda_d2a', type=float, default=0, help='lambda for KL loss')
        self.parser.add_argument('--lambda_d2d', type=float, default=0, help='lambda for KL loss')
        self.parser.add_argument('--lambda_t2m', type=float, default=1, help='lambda for KL loss')
        self.parser.add_argument('--lambda_t2t', type=float, default=0, help='lambda for KL loss')
        self.parser.add_argument('--lambda_m2t', type=float, default=0, help='lambda for KL loss')
        self.parser.add_argument('--lambda_m2m', type=float, default=0, help='lambda for KL loss')

        self.is_train = True

        # for evaluation, and this should be in the name of token.
        self.parser.add_argument('--which_vqvae', type=str, default='finest', help='Dataset Name')
...
class TrainVQTokenizerOptions():
    def __init__(self):
        ...
        # adv in vqvae not working here.
        self.parser.add_argument('--start_dis_epoch', type=float, default=300, help='Layers of GRU')
