...
class Pose2Feature22J(object):
    def __init__(self):
        self.n_raw_offsets = None
        self.kinematic_chain = None
        self.l_idx1 = None
        self.l_idx2 = None
        self.face_joint_indx = None
        ...
        joints_num = 22
        # ds_num = 8
        # data_dir = '../HumanML3D_22joint_20fps/joints/'
        data_dir = './tools/HumanML3D_22joint_20fps/joints/'
        # data_dir = '../HumanML3D_22joint_20fps_sthwrong/joints/'
    ...
    def process_file(self, positions, feet_thre=0.002):
        ...
        #     plot_3d_motion("./positions_1.mp4", self.kinematic_chain, positions, 'title', fps=20)
        ...
        #     plot_3d_motion("./positions_2.mp4", self.kinematic_chain, positions, 'title', fps=20)
        ...
        def foot_detect(positions, thres):
            ...
            #     feet_l_h = positions[:-1,self.fid_l,1]
            ...
            #     feet_r_h = positions[:-1,self.fid_r,1]
    ...
    def pose2feature(self, pose_seq):
        """
        :param pose_seq: tx22x3
        :return:
        """
        feature, *_ = self.process_file(pose_seq)
        return feature

    def feature2pose(self, feature, joints_num):
        """
        :param feature: tx263
        :return:
        """
        rec_ric_data = self.recover_from_ric(torch.from_numpy(feature).unsqueeze(0).float(), joints_num)
        return rec_ric_data.numpy()[0]
...
#
#     #     self.n_raw_offsets = torch.from_numpy(t2m_raw_offsets)
#     #     self.kinematic_chain = t2m_self.kinematic_chain
#     self.n_raw_offsets = torch.from_numpy(smpl24_raw_offsets)
#     self.kinematic_chain = smpl24_kinematic_chain
#
#     # Get offsets of target skeleton
#     example_data = np.load(os.path.join(data_dir, example_id + '.npy'))
#     example_data = example_data.reshape(len(example_data), -1, 3)
...
#     # (joints_num, 3)
#     self.tgt_offsets = tgt_skel.get_offsets_joints(example_data[0])
#     # print(self.tgt_offsets)
#
#     source_list = os.listdir(data_dir)  # [:10]
#     frame_num = 0
