...
from networks.trainers_x5 import TransformerA2DTrainerV2
...
"""
This file is to train the music2dance
"""
...
if __name__ == '__main__':
    ...
    all_params = 0
    pc_transformer = sum(param.numel() for param in a2d_transformer.parameters())
    print(a2d_transformer)
    ...
    trainer = TransformerA2DTrainerV2(opt, a2d_transformer)
    ...
    train_loader = DataLoader(train_dataset_a2d, batch_size=opt.batch_size, drop_last=True, num_workers=4,
                              shuffle=True, pin_memory=True)
    val_loader = DataLoader(val_dataset_a2d, batch_size=16, drop_last=True, num_workers=4,
                            shuffle=True, pin_memory=True)
