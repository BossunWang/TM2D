...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--tokenizer_name', type=str, default="none", help='Name of this trial')
        ...
        self.parser.add_argument('--t2m_model', type=str, default='t2m_v2', help='Dataset Name')
        ...
        self.parser.add_argument('--tokenizer_name_motion', type=str, default='None', help='Dataset Name')
        self.parser.add_argument('--tokenizer_name_audio', type=str, default='None', help='Dataset Name')

        # Hyper-Parameter for sphere information neck
        self.parser.add_argument('--d_sphere', type=int, default=128, help='Dimension of sphere information neck')
        self.parser.add_argument('--dec_mix_in', default='1', type=str, help='use decoder layer separated by comma')
